      ...
      <div className="w-full">
        ...
        >
          ...
          <label className="w-1/5 flex flex-col gap-2">
            <button
              className="bg-green-400 px-4 py-2 rounded-md hover:bg-green-400/70 transition-[.5s]"
            ...
            <button
              className="bg-grey-200 px-4 py-2 rounded-md hover:bg-grey-200/70 transition-[.5s]"
